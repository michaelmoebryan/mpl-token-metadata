...
export function delegateAuthorityItemV1(
  ...
  // Arguments.
  const resolvedArgs: DelegateAuthorityItemV1InstructionArgs = { ...input };
  ...
  // Data.
  const data = getDelegateAuthorityItemV1InstructionDataSerializer().serialize(
    resolvedArgs as DelegateAuthorityItemV1InstructionDataArgs
  );
