...
export function delegateTransferV1(
  ...
  // Arguments.
  const resolvedArgs: DelegateTransferV1InstructionArgs = { ...input };
  ...
  // Data.
  const data = getDelegateTransferV1InstructionDataSerializer().serialize(
    resolvedArgs as DelegateTransferV1InstructionDataArgs
  );
