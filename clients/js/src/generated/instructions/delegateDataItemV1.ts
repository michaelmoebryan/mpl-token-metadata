...
// Args.
export type DelegateDataItemV1InstructionArgs = PickPartial<
  DelegateDataItemV1InstructionDataArgs &
    DelegateDataItemV1InstructionExtraArgs,
  'updateAuthority'
>;
...
export function delegateDataItemV1(
  ...
  // Arguments.
  const resolvedArgs: DelegateDataItemV1InstructionArgs = { ...input };
  ...
  // Data.
  const data = getDelegateDataItemV1InstructionDataSerializer().serialize(
    resolvedArgs as DelegateDataItemV1InstructionDataArgs
  );
